export const endpoints = {
  ...
  guilds: {
    ...
    tempVoiceChannels: (guildId: string) => `/guilds/${guildId}/voice/temp/channels`,
    tickets: (guildId: string) => `/guilds/${guildId}/tickets`,
    ...
    levelingRoleRewards: (guildId: string) => `/guilds/${guildId}/leveling/role-rewards`,
    levelingRoleReward: (guildId: string, level: number) => `/guilds/${guildId}/leveling/role-rewards/${level}`,
